...
function addManager() {
    inquirer.prompt([
        ...
        .then(function (data) {
            ...
            const teamMember = new Manager(name, id, email, officeNumber, role)
...
function addEngineer() {
    inquirer.prompt([
        ...
        .then(function (data) {
            ...
            const role = data.role
            const teamMember = new Engineer(name, id, email, github, role)
            finalTeamArray.push(teamMember)
            addTeamMembers()
        });
...
function addIntern() {
    inquirer.prompt([
        ...
        .then(function (data) {
            ...
            const role = data.role
            const teamMember = new Intern(name, id, email, school, role)
            finalTeamArray.push(teamMember)
            addTeamMembers()
        });
